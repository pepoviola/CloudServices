...
Public Class Crypto
    ...
    Private Shared ReadOnly instance As Crypto = New Crypto
    Private Sub New()

    End Sub
    Public Shared Function getCrypto() As Crypto
        Return instance
    End Function
    ...
    Public Function generarMD5(ByVal cadena As String) As String
        'objeto de codificacion
        Dim ueCodigo As New UnicodeEncoding()
        'intancia para codificacion
        Dim MD5 As New MD5CryptoServiceProvider()

        'calculo el hash
        Dim bHash() As Byte = MD5.ComputeHash(ueCodigo.GetBytes(cadena))
        'convierto el hash a string y lo devuelvo
    ...
    Public Function CompareHashMD5(ByVal value As String, ByVal hash As String) As Boolean
        ...
        Return (hash.Equals(Me.generarMD5(value)))
    End Function
