        ...
        Else
            ...
            If context.Request.HttpMethod = "POST" Then
                ...
                Try
                    ...
                    If oblPlat.Crear(oServer) Then
                        resp.Add("status", "200")
                        resp.Add("msg", Infra.TraductorMgr.TraducirControl("server_add_ok", context.Session("lang")))
                        oBita.Descripcion = "Se creó con éxito el server " + oServer.Hostname
                    Else
                        resp.Add("status", "400")
                        resp.Add("msg", Infra.TraductorMgr.TraducirControl("server_add_err", context.Session("lang")))
                        oBita.Descripcion = "Error al crear el server " + oServer.Hostname
                    End If
